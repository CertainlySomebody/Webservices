...
<div class="container">
    ...
    <form action="" method="POST" id="insertForm">
        <?php
            if(isset($_GET['table']) && $_GET['table'] == 'ships') {
                echo '<div class="form-group"><input type="text" name="shipName" placeholder="Input Ship Name" required /></div>';
                echo '<div class="form-group"><input type="text" name="shipDescription" placeholder="Input Ship Description" required /></div>';
                echo '<div class="form-group"><input type="text" name="shipClass" placeholder="Input Ship Class" required /></div>';
                echo '<div class="form-group"><input type="text" name="shipRace" placeholder="Input Ship Race" required /></div>';
                echo '<div class="form-group"><input type="number" name="highSlots" placeholder="Input Ship High Slots" required /></div>';
                echo '<div class="form-group"><input type="number" name="medSlots" placeholder="Input Ship Medium Slots" required /></div>';
                echo '<div class="form-group"><input type="number" name="lowSlots" placeholder="Input Ship Low Slots" required /></div>';
                echo '<div class="form-group"><input type="number" name="rigSlots" placeholder="Input Ship Rig Slots" required /></div>';
                echo '<div class="form-group"><input type="number" name="volume" placeholder="Input Ship Volume" required /></div>';
                echo '<div class="form-group"><input type="number" name="price" placeholder="Input Ship Price" required /></div>';
                echo '<div class="form-group"><input type="number" name="shipTier" placeholder="Input Ship Tier" required /></div>';
            }elseif (isset($_GET['table']) && $_GET['table'] == 'modules') {
                echo '<div class="form-group"><input type="text" name="moduleType" placeholder="Input Module Type" required /></div>';
                echo '<div class="form-group"><input type="text" name="moduleDesc" placeholder="Input Module Description" required /></div>';
                echo '<div class="form-group"><input type="text" name="moduleCategory" placeholder="Input Module Category" required /></div>';
                echo '<div class="form-group"><input type="number" name="moduleVolume" placeholder="Input Module Volume" required /></div>';
                echo '<div class="form-group"><input type="number" name="moduleTier" placeholder="Input Module Tier" required /></div>';
    ...
    <?php
        if(isset($_GET['table']) && isset($_POST['submit'])) {
            ...
            $client = curl_init();
            curl_setopt($client, CURLOPT_URL, "http://localhost/webservices/api/$table/insert.php");
            if($table == 'ships') {
